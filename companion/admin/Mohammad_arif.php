    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
				...
				?>
                <a style="color:#FFF;" class="navbar-brand" href="#page-top"> <?php echo $name; ?></a>
            </div>
			...
			$total="";}
				...
				?>
                    <li class="page-scroll">
                        <a href="../profile/mymesseges.php">Messeges<sup style="font-size:18px;"><?php echo $total; ?></sup></a>
                    </li>
                    
                    <li class="page-scroll">
                        <a href="../blogs/Mohammad_arif_blogs.php">Mohammad Arif Blog</a>
                    </li>
                    <li class="page-scroll">
                        <a href="../blogs/check_blogs.php">Review Blogs</a>
                    </li>
                    <li class="page-scroll">
