...
{
	header("location:Mohammad_arif.php");
}
ob_start();
?>
<html lang="en">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="page-heading">
                        <h1>Login</h1>
                        <hr class="small">
                        <span class="subheading">Welcome Mohammad Arif</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <?php
								...
								{
								$email1=htmlentities($_POST["uemail"]);
								$pass=htmlentities($_POST["upass"]);
								
				
		$result=mysqli_query($arif,"select * from admin where email='$email1' and password='$pass'");
		if(mysqli_num_rows($result) > 0)
		{
			$resultset=mysqli_fetch_assoc($result);
			$dbemail=$resultset["email"];
			$dbpass=$resultset["password"];
			if($dbemail==$email1 && $dbpass==$pass)
			{
				session_start();
				$_SESSION["Admin"]=$dbemail;
				header("location:Mohammad_arif.php");	
			}
			else
		{
