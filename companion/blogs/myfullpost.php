...
{
header("location:Mohammad_arif_blogs.php");	
}	
}
?>
<html lang="en">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="Mohammad_arif_blogs.php">Home</a>
                    </li>
...
<div class="container">
            <div class="row">
               ...
               <?php  
						...
						$rs=mysqli_query($arif,"select email from tbl_like where postid='$id' and email ='".$_SESSION["Admin"]."'"); # here we have used the select querry. we should remember that by using a select  querry we are returned with some result. we have stored that result in a varaible rs.
