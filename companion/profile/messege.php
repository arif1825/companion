...
$b=mysqli_fetch_assoc($a);
  $admin=$b["email"];
				    $m=mysqli_query($arif,"select * from messege where tmsg='$email' and fmsg='$admin' and status='unread'");
			...
			$total="";	
					...
					?><li class="page-scroll">
                        <a href="msgadmin.php">Messege Admin<sup><?php echo $total; ?></sup></a>
                    </li>
    ...
    <section id="portfolio">
        <div class="container">
			...
			if(mysqli_num_rows($m) > 0)
			{
				...
				?>
				<a href="readmsg.php?email=<?php echo $a; ?>" style="color:black; font-size:18px; font-weight:700;"><?php echo $a; ?></a>&nbsp;&nbsp;<?php echo $date;  ?>&nbsp;&nbsp;<?php
				?> &nbsp;&nbsp;<?php echo $status;  ?>&nbsp;&nbsp;<a href="del_allmsgs.php?email=<?php echo $a; ?>" style="color:red;">Delete</a><br><br>
