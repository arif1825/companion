...
$a=mysqli_query($arif,"select * from admin");
        ...
        <div class="container">
			...
			$femail=$_SESSION["useremail"];
				...
				if(mysqli_num_rows($m) > 0)
				{
					...
					while($a=mysqli_fetch_assoc($m))
					{
					 ...
					 $d=mysqli_fetch_assoc($c);
					  echo $nam=$d["name"];
					 ?>&nbsp;&nbsp;<span style="color:green; font-size:18px;"><?php	echo $msg=$a["messege"];?></span> &nbsp;&nbsp;<?php echo $a["date"];?> &nbsp;&nbsp;<a style="color:red;" href="delmsg.php?id=<?php echo $id; ?>&email=<?php echo $toemail; ?>">Delete</a><br><?php
					}	
				}
             ...
             <form  method="post" novalidate >
				...
				{
					$mesg=$_POST["umsg"];
					mysqli_query($arif,"insert into messege (fmsg,tmsg,messege,date,status) values ('$femail','$email','$mesg',NOW(),'unread')");
