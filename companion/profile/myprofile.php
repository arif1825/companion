    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <?php
				$p=mysqli_query($arif,"select * from register where email='$email'");
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="../blogs/editmyprofile.php">Edit Profile</a>
                    </li>
                    <li class="page-scroll">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
						...
						<?php
            $a=mysqli_query($arif,"select * from profile where email='$email'");
			if(mysqli_num_rows($a) > 0 )
			{
				$b=mysqli_fetch_assoc($a);
			$pic=$b["profilepic"];
			?>
			<img style="width:350px; height:350px; border-radius:100%;" class="img-responsive" src="<?php echo $pic ?>" alt="">
			<?php	
			}
			else
			{
				?>
				<img style="width:400px; height:400px; border-radius:100%;" class="img-responsive" src="img/profile.png" alt="">
				<?php
				}
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-4">
						...
						?>
                        <p style="text-transform:capitalize;"><?php echo $loc; ?><br><?php echo $town; ?></p><?php }
						else{
							$loc="Not Updated";
						$date="Not Updated";
						$town="Not Updated";
						...
						<p style="text-transform:capitalize;"><?php echo $loc; ?><br><?php ; ?></p>
						<?php
