    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                $result=mysqli_query($arif,"select * from admin where email='$email'");
    ...
    <section id="portfolio">
        <div class="container">
			...
			$email=$_GET["email"];
                ...
                $result=mysqli_query($arif,"select * from admin where email='$email'");
				$resultset=mysqli_fetch_assoc($result);
				 echo $nam=$resultset["name"];	  
					}
 ?>&nbsp;&nbsp;<span style="color:green;"><?php	echo $msg=$a["messege"];?></span> &nbsp;&nbsp;<?php echo $a["date"];?> 
&nbsp;&nbsp;<a style="color:red;" href="delmymsg.php?id=<?php echo $id; ?>&email=<?php echo $email; ?>">Delete</a><br><?php
					}	
				}
             ...
             <form  method="post" novalidate >
                 <div class="row control-group">
                    ...
                    <div class="row">
                        <div class="form-group col-xs-12">
                            <button type="submit" onClick="status1()" name="btnmsg" class="btn btn-default">Send</button>
                        </div>
                    </div>
                </form>
                <?php
                if(isset($_POST["btnmsg"]))
				{
					...
					header("location:readmymsg.php?email=".$email);	
